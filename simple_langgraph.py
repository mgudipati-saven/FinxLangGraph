...
LLM = ChatOpenAI(model_name="gpt-3.5-turbo-0125", streaming=True)
...
workflow.add_conditional_edges("agent", continue_or_end_test, {"continue": "tool_executor", "END": END})
...
if __name__ == "__main__":
  call_weather_app("Give me a visual image displaying the current weather in Hyderabad, India.")